module "sidekiq" {
  ...
  custom_tags = merge(var.additional_tags, var.custom_tags, var.sidekiq_custom_tags)
  ...
  disk_kms_key_arn           = var.sidekiq_disk_kms_key_arn != null ? var.sidekiq_disk_kms_key_arn : (var.default_disk_kms_key_arn != null ? var.default_disk_kms_key_arn : var.default_kms_key_arn)
  ...
  user_data_base64           = var.sidekiq_user_data_base64
