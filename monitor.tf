module "monitor" {
  ...
  custom_tags = merge(var.additional_tags, var.custom_tags, var.monitor_custom_tags)
  ...
  disk_kms_key_arn           = var.monitor_disk_kms_key_arn != null ? var.monitor_disk_kms_key_arn : (var.default_disk_kms_key_arn != null ? var.default_disk_kms_key_arn : var.default_kms_key_arn)
  ...
  user_data_base64           = var.monitor_user_data_base64
